(() => {
  ...
  window.onload = function () {
    var t = new l(),
      elements = document.getElemenyById("button"); // Select all elements with data-target
    const popper1 = document.querySelector(".party-popper-1");
    const popper2 = document.querySelector(".party-popper-2");

    elements.forEach((element) => {
      element.addEventListener("click", function () {
        t.addConfetti(); // Trigger confetti effect

        // Show party poppers
        popper1.style.display = "block";
        popper2.style.display = "block";

        // Hide party poppers after animation is complete
        setTimeout(() => {
          popper1.style.display = "none";
          popper2.style.display = "none";
        }, 3000);
      });
    });
  };
